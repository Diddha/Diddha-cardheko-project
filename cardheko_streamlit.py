...
model = joblib.load(r'C:\Users\HP\Downloads\final_random_forest_model1 (1).pkl')
label_encoders = joblib.load(r'C:\Users\HP\Downloads\label_encoder.pkl')
scalers = joblib.load(r'C:\Users\HP\Downloads\min_max.pkl')  # Assuming this is your loaded scaler for inverse transformation

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r'C:\Users\HP\Desktop\structured_cars_dataset\cleaned_cardata.csv')
